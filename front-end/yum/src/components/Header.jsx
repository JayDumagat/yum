import InputClear from "../Icons/InputClear";
...
function Header() {
  ...
  return (
    <div className="relative">
      <header className="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-[48] w-full bg-white  text-sm py-2.5 lg:ps-[260px] dark:bg-neutral-950">
            ...
            <div className="hidden md:block">
              <div className="relative hidden">
                ...
                <input
                  ...
                  className="py-2 ps-10 pe-16 block w-full bg-white border-2  border-gray-200 rounded-lg text-sm focus:outline-none focus:border-2 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder:text-neutral-400 dark:focus:ring-neutral-600"
                  placeholder="Search"
                />
                {searchValue && (
                  <div
