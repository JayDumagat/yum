...
const renderIcon = (cell) => {
  if (cell.includes("Paypal")) {
    return <FaPaypal className="text-blue-900 text-xl" />;
  } else if (cell.includes("Visa")) {
    return <FaCcVisa className="text-blue-900 text-2xl" />;
  } else if (cell.includes("Mastercard")) {
    return <FaCcMastercard className="text-blue-900 text-2xl" />;
  }
  return cell;
};

const renderBadge = (cell) => {
  if (cell.includes("Paid")) {
    return (
  ...
  } else if (cell.includes("Declined")) {
    return (
...
const Table = ({ columns, data }) => {
  return (
    <div className="bg-white border h-[310px] overflow-scroll border-gray-200 rounded-xl shadow-sm  dark:bg-neutral-900 dark:border-neutral-700">
      <div className=" overflow-y-hidden px-6 py-4">
        <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
          ...
          <div className="hidden sm:col-span-2 md:grow">
            <div className="flex justify-end gap-x-2">
              <div className="hs-dropdown [--placement:bottom-right] relative inline-block">
                ...
                <div className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden divide-y divide-gray-200 min-w-48 z-10 bg-white shadow-md rounded-lg p-2 mt-2 dark:divide-neutral-700 dark:bg-neutral-800 dark:border dark:border-neutral-700">
              ...
              <div className="hs-dropdown relative inline-block [--placement:bottom-right]' data-hs-dropdown-auto-close=">
                <button
        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
          ...
          <tbody className="overflow-x-scroll divide-y divide-gray-200 dark:divide-neutral-700">
        ...
        <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-gray-200 dark:border-neutral-700">
          <div className="max-w-sm space-y-3">
            <select className="hidden py-2 px-3 pe-9  w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
              <option>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
