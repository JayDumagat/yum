...
function Sidebar() {
  const { isOpen, dropdownOpen, toggleDropdown } = useSidebarStore();
  return (
    <div>
      <div
        className={`transition-transform z-50 duration-300 transform w-[260px] h-full fixed inset-y-0 start-0 z-60 bg-white dark:bg-neutral-950  ${
              ...
              <ul className="flex flex-col space-y-1">
                ...
                <li className="hidden">
                  <SidebarDropdown
                    ...
                    icon={<UserRoundCog />}
                    isOpen={dropdownOpen["My Staff"]}
                    toggle={() => toggleDropdown("My Staff")}
                  >
